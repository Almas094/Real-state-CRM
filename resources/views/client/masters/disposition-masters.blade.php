...
<section class="pc-container">
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-3">Disposition List</h2>
            </div>
          </div>
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Disposition List</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-12">
            <div class="card">
              <div class="card-header table-header">
                <div class="row">
                    <div class="col-8">
                        <h5 class="mt-2">Disposition List</h5>
                    </div>
                    <div class="col-4 text-right">
                        <button type="button" class="btn btn-primary me-3 d-inline-flex" id="openSidebarBtn"><i class="ti ti-circle-plus me-2"></i>Add Disposition</button>
                    </div>
                </div>
              </div>
              <div class="card-body">
    ...
    <div class="crm-sidebar" id="crmSidebar">
        ...
        <h2>Add Disposition</h2>

        <form id="AddDispositionForm" class="mt-3">
            <div class="form-group">
                <label class="form-label" for="AddDisposition">Disposition</label>
                <input type="text" class="form-control" id="AddDisposition" placeholder="Please enter value">
                <div class="error-message" id="dispositionError">This field is required.</div>
            </div>
            <div class="form-group">
                <label class="form-label" for="StatusDisposition">Status</label>
                <select class="form-select" id="StatusDisposition">
    ...
    <script>
      // Add Disposition Form Validation
      document.addEventListener('DOMContentLoaded', function () {
          document.getElementById('AddDispositionForm').addEventListener('submit', function (event) {
              event.preventDefault(); // Prevent form submission

              // Get form elements
              const dispositionInput = document.getElementById('AddDisposition');
              const dispositionError = document.getElementById('dispositionError');

              const statusSelect = document.getElementById('StatusDisposition');
              const statusError = document.getElementById('statusError');

              let isValid = true;

              // Reset error states
              dispositionInput.classList.remove('error');
              dispositionError.style.display = 'none';

              statusSelect.classList.remove('error');
              statusError.style.display = 'none';

              // Validate Disposition Input
              if (dispositionInput.value.trim() === '') {
                  isValid = false;
                  dispositionInput.classList.add('error');
                  dispositionError.style.display = 'block';
              }
              ...
              if (isValid) {
                  window.location.href = "https://app.abstractcrm.com/client/master/disposition-list";
              }
          });
      });
    </script>
