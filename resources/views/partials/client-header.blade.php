    ...
    <div class="me-auto pc-mob-drp">
      <ul class="list-unstyled">
        ...
        <li class="dropdown pc-h-item">
          <form class="px-3 py-2 input-group">
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <h5 class="text-body mb-2">Alert</h5>
                      <p class="mb-3">New lead has been added to CRM. Contact details: [Lead_Name] - [Mobile_Number].</p>
                      <button class="btn btn-sm btn-outline-secondary me-2 nt-btn">Add Remark</button>
              ...
              <div class="card mb-2">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <span class="float-end text-sm text-muted">15 mins ago</span>
                      <h5 class="text-body mb-2">Reminder</h5>
                      <p class="mb-3">Please follow up with [Lead_Name] - [Mobile_Number] as scheduled on [Date] - [Time].</p>
                      <button class="btn btn-sm btn-outline-secondary me-2 nt-btn">Add Remark</button>
                      <button class="btn btn-sm btn-primary nt-btn">View Details</button>
                    </div>
                  </div>
              ...
              <div class="card mb-2">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <span class="float-end text-sm text-muted">21 hours ago</span>
                      <h5 class="text-body mb-2">Reminder</h5>
                      <p class="mb-3">Please follow up with [Lead_Name] - [Mobile_Number] as scheduled on [Date] - [Time].</p>
                      <button class="btn btn-sm btn-outline-secondary me-2 nt-btn">Add Remark</button>
                      <button class="btn btn-sm btn-primary nt-btn">View Details</button>
