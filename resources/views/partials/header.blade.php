      ...
      <ul class="list-unstyled">
        ...
        <li class="dropdown pc-h-item">
          <form class="px-3 py-2 input-group">
            <input type="text" class="form-control  h-250" aria-label="Text input with segmented dropdown button" placeholder="Search here. . .">
            <button type="button" class="btn btn-outline-secondary bd-1">Search</button>
            <button type="button" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split bd-1 bd-left-none"
            ...
            <div class="dropdown-body">
              <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                <div class="d-flex mb-1">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">Raj Makhija 🖖</h6>
                    <span>connect@abstractdigitalworld.in</span>
                  </div>
                </div>
