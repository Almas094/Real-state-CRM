        ...
        <div class="card table-card">
          ...
          <div class="card-header table-header">
            ...
            <div class="row">
              ...
              <div class="col-10">
                ...
                <button type="button" class="btn btn-primary me-3 d-inline-flex btn-i-wh15px" onclick="openRoleSidebar()">

                  <i data-feather="user-plus" class="me-1 mt-1 wh15px"></i> Add Role
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              ...
              <table class="table table-striped" id="rolesTable" width="100%">
...
<div id="RoleSidebar" class="sdbr-sidebar">

  <button class="sdbr-close-button" onclick="closeRoleSidebar()">&times;</button>

  <h2 id="sidebarTitle">Add Role</h2>
  ...
  <form id="roleForm">
    ...
    <div class="row mb-2">
      ...
      <div class="col-12">
        ...
        <input type="text" id="role_name" name="name" class="form-control" placeholder="Entert Name" required>
    ...
    <div class="row mb-2">
      ...
      <div class="col-12">
        ...
        <select class="form-control users-limit mb-2" name="status" id="role_status" required>
    ...
    <div class="row">
      ...
      <div class="col-4">
        ...
        <button type="button" class="btn mt-2 btn-secondary" style="width:100%;" onclick="resetRoleForm()">Reset</button>
...
$(document).ready(function() {
  ...
  $(document).on('change', '.toggle-status', function() {
    ...
    $.ajax({
      ...
      url: `{{route('master.roles.updateStatus')}}`,
  ...
  $(document).on('click', '.edit-role', function() {
    ...
    let url = "{{ route('master.roles.edit', ':id') }}";
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          ...
          url: "{{ route('master.roles.delete', ':id') }}".replace(':id', id),
  ...
  $('#roleForm').on('submit', function(e) {
    ...
    let url = id 
        ...
        ? "{{ route('master.roles.update', ':id') }}".replace(':id', id)

        : "{{ route('master.roles.store') }}";
